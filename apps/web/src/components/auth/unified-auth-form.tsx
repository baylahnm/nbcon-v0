  ...
  return (
    <div className="w-full flex items-center justify-center p-8 bg-gradient-to-br from-background via-muted/10 to-background">
      <div className="w-full max-w-md">
        ...
        {/* Auth Card */}
        <Card className="border-border/20 shadow-xl bg-card dark:bg-[#181818]">
          ...
          <CardContent className="p-4 space-y-4">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="login" className="space-y-4 mt-2">
                ...
                <div className="relative mb-6">
                  ...
                  <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-card dark:bg-[#181818] px-2 text-muted-foreground">or</span>
                  </div>
                </div>
              ...
              <TabsContent value="signup" className="space-y-4 mt-2">
                {/* Social Login Buttons */}
                <div className="grid grid-cols-2 gap-3 mb-6">
                  <Button variant="outline" className="h-11 border border-input bg-background dark:bg-[#212121] shadow-sm shadow-black/5 hover:bg-accent hover:text-accent-foreground" type="button">
                    <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                      <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                      <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
                      <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" />
