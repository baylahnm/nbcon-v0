          ...
          <CardContent className="p-4 space-y-4">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <div className="border-b border-border mb-6">
                <TabsList className="inline-flex items-center justify-center w-full h-auto bg-transparent p-0 border-0 rounded-none">
              ...
              <TabsContent value="login" className="space-y-4 mt-2">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-primary text-primary-foreground hover:opacity-90 h-10" disabled={isLoading}>
                    {isLoading ? (
                      <>
