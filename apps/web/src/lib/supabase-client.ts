...
const supabaseUrl = 
  ...
  (typeof window !== 'undefined' && (window as WindowWithEnv).__ENV__?.VITE_SUPABASE_URL) ||
  undefined;

const supabaseAnonKey = 
  (typeof process !== 'undefined' && process.env?.NEXT_PUBLIC_SUPABASE_ANON_KEY) ||
  (typeof process !== 'undefined' && process.env?.VITE_SUPABASE_ANON_KEY) ||
  (typeof window !== 'undefined' && (window as WindowWithEnv).__ENV__?.VITE_SUPABASE_ANON_KEY) ||
  undefined;
